/**
 * Opus codec wrapper - portable version.
 * Identical to desktop version; opus.h is from libopus.
 */
#include "codec.h"
#include <opus.h>
#include <stdlib.h>
...
int codec_enc_encode(codec_enc_t *e, const short *pcm, int frame_size,
...
int codec_dec_decode(codec_dec_t *d, const uint8_t *data, int len,
